...
The project will be implemented on Ubuntu 22.04.
Can you help me planning a detailed workflow to implement this project step by step?
It would be great to have steps which can be done one by one and can be tested independently.
